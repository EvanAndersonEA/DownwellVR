...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Downwell p_Downwell;
        ...
        public static SteamVR_Input_ActionSet_Downwell Downwell
        {
            get
            {
                return SteamVR_Actions.p_Downwell.GetCopy<SteamVR_Input_ActionSet_Downwell>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Downwell = ((SteamVR_Input_ActionSet_Downwell)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Downwell>("/actions/Downwell")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Downwell};
        }
    }
}
